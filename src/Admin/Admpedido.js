                                            ...
                                            <>
                                                {data.filter(varid => varid).map(filname => (
                                                    <tr>
                                                        ...
                                                        <td>{/*filname.PedEntrega !== "Entregado" ? <>{filname.PedEntrega} | <a class="cambio_entrega" onClick={() => Pedido_entregado(filname._id)}>Entregar</a></> : filname.PedEntrega*/}
                                                        <a class="cambio_entrega" onClick={() => gestionar_Pedido(filname._id)}>Gestionar</a></td>
                                                        {/*<td>
